...
public final class AlarmClockFragment extends DeskClockFragment implements
    ...
    @Override
    public void onRightButtonClick(@NonNull Button left) {
        mAlarmUpdateHandler.hideUndoBar();
        startCreatingAlarm();
    }
    ...
    public void onUpdateFabButtons(@NonNull Button left, @NonNull Button right) {
        ...
        left.setText(R.string.sw_edit_button);

        right.setVisibility(View.VISIBLE);
        right.setClickable(true);
//        right.setText(R.string.sw_add_button);
        right.setText("+");
//        right.setTextSize(22f);
//        right.setTextColor(resources.getColor(R.color.black));
    }
