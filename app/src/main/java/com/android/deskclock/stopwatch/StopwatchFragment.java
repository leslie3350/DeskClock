...
public final class StopwatchFragment extends DeskClockFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state) {
        ...
        mPointText = (TextView) v.findViewById(R.id.stopwatch_point_text);
        mHundredthsTimeText = (TextView) v.findViewById(R.id.stopwatch_hundredths_text);
        mStopwatchTextController = new StopwatchTextController(mMainTimeText, mPointText, mHundredthsTimeText);
...
//        mHundredthsTimeText.setTextColor(timeTextColor);
        ...
        mStartStop = (Button) v.findViewById(R.id.bt_start_stop);
        mStartStop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (getStopwatch().isRunning()) {
                    doPause();
                    mStartStop.setText(R.string.shortcut_start_stopwatch_short);
                    mCountReset.setText(R.string.stopwatch_reset);
                } else {
                    doStart();
                    mStartStop.setText(R.string.timer_stop);
                    mCountReset.setText(R.string.stopwatch_lap);
                }
            }
        });
        mCountReset = (Button) v.findViewById(R.id.bt_count_reset);
