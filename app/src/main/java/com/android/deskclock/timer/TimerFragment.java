...
public final class TimerFragment extends DeskClockFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.timer_fragment2, container, false);
...
//        LinearLayout timeLayout = (LinearLayout) view.findViewById(R.id.timePicker1);
//        timeLayout.addView(getTimePickerView());
        timePicker = view.findViewById(R.id.timePicker);
        timerPickerView = new TimerPickerView(timePicker);
        timerPickerView.initDateTimePicker(-1, 0, 0, 0, 0,0);//传入-1则不显示该列
        btGetTime = (Button) view.findViewById(R.id.bt_get_time);
        mTimerText = (TextView) view.findViewById(R.id.stopwatch_time_text);
...
//                tvTime.announceForAccessibility(TimerStringFormatter.formatString(
//                        getContext(), R.string.timer_accessibility_started, 20, true));
//                timePicker.setVisibility(View.GONE);
    ...
    private View getTimePickerView() {
        View timepickerview = View.inflate(getActivity(), R.layout.timepicker, null);
        // 获取当前时间
        ...
        timerPickerView.initDateTimePicker(year, month, day, 0, 0,0);//传入-1则不显示该列
    ...
    private void showCreateTimerView(int updateTypes) {
        ...
        mCreateTimerView.setVisibility(INVISIBLE);
