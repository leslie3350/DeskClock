...
public final class StopwatchTextController {
    ...
    public StopwatchTextController(TextView mainTextView, TextView pointText, TextView hundredthsTextView) {
    ...
    public void setTimeString(long accumulatedTime) {
        ...
        if (hours != 0) {
            mHundredthsTextView.setVisibility(View.GONE);
            mPointText.setVisibility(View.GONE);
        } else {
            mHundredthsTextView.setVisibility(View.VISIBLE);
