...
public final class UiDataModel {
    ...
    public enum Tab {
        ALARMS(AlarmClockFragment.class, R.drawable.ic_tab_alarm2, R.string.menu_alarm),
        STOPWATCH(StopwatchFragment.class, R.drawable.ic_tab_stopwatch2, R.string.menu_stopwatch),
        CLOCKS(ClockFragment.class, R.drawable.ic_tab_clock2, R.string.menu_clock),
        TIMERS(TimerFragment.class, R.drawable.ic_tab_timer2, R.string.menu_timer);
